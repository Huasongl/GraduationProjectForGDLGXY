package com.gdlgxy.internshipcommunity.module.manger;

import android.app.Application;
import android.net.Uri;

import com.gdlgxy.internshipcommunity.CommunityApplication;
import com.gdlgxy.internshipcommunity.widget.PageListPlay;
...
public class PageListPlayManager {
    ...
    static {
        Application application = CommunityApplication.getApplication();
        //创建http视频资源如何加载的工厂对象
